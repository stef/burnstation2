...
class Menu(gtk.MenuBar):
    ...
    def __init__(self, window):
        ...
        fake_array_for_translations = [
            ...
            _("About"), _("Help"), _("Developer Information"), _("Report a Bug"), _("Translation"),     # Sub Help
        ...
        sub3 = ["Help", "---", "Developer Information", "Report a Bug", "Translation", "---", "About"]  #"Feature requests",
        ...
        #~ feature = self.get_submenu("Feature requests")
        #~ self.set_item_image(feature, "clip_note_1.png")
        #~ feature.connect("activate", self.cb_feature)
        ...
        self.set_item_image(plugins, "preferences_plugin.png") ##gtk.STOCK_ABOUT
...
#        tmp.set_property("use-underline", False)
    ...
    ## Called when the feature request MenuItem was clicked
    # @param Object Pointer
    # @param widget The MenuItem clicked
    def cb_feature(self, widget):
        self.pyjama.Events.raise_event("open_url", "http://blueprints.launchpad.net/pyjama", force_default=True)
